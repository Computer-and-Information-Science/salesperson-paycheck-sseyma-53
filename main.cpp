...
inData >> firstName >> lastName >> baseSalary >> commissionPercent >> sales >> expenses;
...
cout << "Commission: " << setw(11) << right << commission << setprecision(2) << " (";
cout << setprecision(1) << commissionPercent << "% of " << setprecision(2) << sales << ")" << endl;
